...
import PROFILE_PIC from "../../assets/images/profile-img2.png";
              ...
              >
                ...
                <motion.a
                  ...
                  className={`
                          ...
                          ${
                            isDarkMode
                              ? "border-gray-700 text-gray-300 hover:bg-white hover:text-black active:bg-white active:text-black "
                              : "border-gray-300 text-gray-700 hover:bg-white hover:text-black active:bg-white active:text-black "
                          }
                        `}
                >
                  <Download size={18} />
                  ...
                  className={`
                          ...
                          ${
                            isDarkMode
                              ...
                              : "border-gray-300 text-gray-700 hover:bg-white hover:text-black"
                          }
                        `}
                >
                  <Download size={18} />
